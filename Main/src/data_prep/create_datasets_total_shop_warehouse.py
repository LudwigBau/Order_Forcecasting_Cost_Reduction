...
if __name__ == "__main__":
    ...
    L_1 = join_weather_holiday(sales_grid_ts_m_d, weather_df, holiday_df)
    ...
    # Join all
    L_3 = join_weather_holiday(m_cyclical_total_sales, weather_df, holiday_df)
    ...
    df_dict = {'L_1': L_1, 'L_2': L_2, 'L_3': L_3}
